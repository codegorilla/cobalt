...
class Generator2 {
  ...
  // We only care about classes in this pass.
  ...
  // I think we just want to set an attribute on the class and not pass the ST
  // any further up. Rendering will be done in a separate phase.

  // We need the member routines to have access to the class name.
